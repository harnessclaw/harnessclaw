                            ...
                            >
                              <div className="flex min-w-0 flex-1 items-center gap-2">
                                <div className="flex min-w-0 items-center gap-2 text-left">
                                  <FolderKanban size={16} className="flex-shrink-0 text-[#4b4f55] dark:text-[#9aa4b2]" />
                                ...
                                <SidebarTooltip label={projectOpen ? t('common.collapse') : t('common.expand')}>
                                  <span className="inline-flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-lg opacity-0 transition-all duration-200 hover:bg-background/80 group-hover/project:opacity-100 group-focus-within/project:opacity-100">
                                    <ChevronDown
                                      ...
                                      aria-hidden="true"
                                      className={cn(
                                        'flex-shrink-0 text-[#4b4f55] opacity-80 transition-transform duration-200 dark:text-[#9aa4b2]',
                              ...
                              <div className="ml-auto flex flex-shrink-0 items-center gap-0.5">
                                <SidebarTooltip label={t('sidebar.more')}>
                                  <button
                                    ...
                                    className={cn(
                                      'pointer-events-none inline-flex h-7 w-7 items-center justify-center rounded-lg text-[#4b4f55] opacity-0 transition-all hover:bg-background/80 hover:opacity-100 group-hover/project:pointer-events-auto group-hover/project:opacity-100 focus-visible:pointer-events-auto focus-visible:opacity-100 dark:text-[#9aa4b2] dark:hover:text-[#eef2ff]',
                                ...
                                <SidebarTooltip label={t('search.newConversation')}>
                                  <button
                                    ...
                                    className="pointer-events-none inline-flex h-7 w-7 items-center justify-center rounded-lg text-[#4b4f55] opacity-0 transition-all hover:bg-background/80 hover:opacity-100 group-hover/project:pointer-events-auto group-hover/project:opacity-100 focus-visible:pointer-events-auto focus-visible:opacity-100 dark:text-[#9aa4b2] dark:hover:text-[#eef2ff]"
                              ...
                              <div className="ml-7 space-y-0.5">
                                {visibleSessions.map((session) => (
                                  ...
                                  >
                                    ...
                                    <span className="flex-shrink-0 text-xs leading-6 text-[#8c9095] dark:text-[#9aa4b2]">
                                ...
                                {!showAllThreads && item.sessions.length > PROJECT_THREAD_PREVIEW_SIZE && (
                                  <button
                                    ...
                                    className="w-full rounded-lg px-2.5 py-1 text-left text-xs font-medium leading-6 text-[#8c9095] transition-colors hover:bg-accent/60 hover:text-[#767676] dark:text-[#9aa4b2] dark:hover:bg-[#1b2130] dark:hover:text-[#d7deea]"
                                  >
                                    {t('sidebar.showMore')}
                                  </button>
                                )}
                      ...
                      >
                        <div className="flex items-center gap-1">
                          {renamingSessionId === item.id ? (
                            ...
                            >
                              <p className="truncate pr-4 text-xs text-[#222529] dark:text-inherit" style={{ fontWeight: 350, lineHeight: '24px' }}>{item.label}</p>
                              {/* 问号提醒：有待回复的问答节点 */}
        ...
        {expanded ? (
          <div className="flex w-full items-center gap-1">
            ...
            >
              ...
              <span className="text-sm font-[350] leading-5 tracking-[0px] text-[#222529] dark:text-inherit">{t('sidebar.settings')}</span>
            </button>
