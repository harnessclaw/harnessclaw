          ...
          {expanded && (
            <div className="mt-6 flex min-h-0 w-full flex-1 flex-col gap-3 pb-3">
              <section className="flex max-h-[46%] min-h-0 flex-col">
                <SidebarTooltip label={projectsExpanded ? t('common.collapse') : t('common.expand')} className="max-w-full">
                  <button
                  ...
                  >
                    ...
                    <img
                      ...
                      aria-hidden="true"
                      className={cn(
                        'opacity-0 transition-all duration-200 group-hover/module:opacity-100 group-focus-visible/module:opacity-100',
                      ...
                      projectItems.map((item) => {
                        ...
                        return (
                          <div key={item.project.project_id} className="space-y-0.5">
                            ...
                            >
                              <SidebarTooltip label={projectOpen ? t('common.collapse') : t('common.expand')} className="flex-1">
                                <button
                                ...
                                >
                                  ...
                                  <ChevronDown
                                    ...
                                    aria-hidden="true"
                                    className={cn(
                                      'flex-shrink-0 text-[#4b4f55] opacity-0 transition-all duration-200 group-hover/project:opacity-80 group-focus-within/project:opacity-80',
              ...
              <section className="flex min-h-0 flex-1 flex-col">
                <SidebarTooltip label={recentExpanded ? t('common.collapse') : t('common.expand')} className="max-w-full">
                  <button
